package com.vazarnold27.countriesdetails.Adapter;
...
import com.vazarnold27.countriesdetails.Activity.R;
import com.vazarnold27.countriesdetails.JavaClasses.ImageFetch;
    ...
    public CountryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new CountryViewHolder(
                LayoutInflater.from(parent.getContext()).inflate(
                        R.layout.item_container_country, parent, false
                )
        );
    }
