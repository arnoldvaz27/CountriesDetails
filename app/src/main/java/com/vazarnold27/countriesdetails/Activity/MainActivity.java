package com.vazarnold27.countriesdetails.Activity;
...
import com.vazarnold27.countriesdetails.Adapter.CountryAdapter;
import com.vazarnold27.countriesdetails.JavaClasses.MySingleton;
import com.vazarnold27.countriesdetails.database.CountryDatabase;
import com.vazarnold27.countriesdetails.entites.Country;
import com.vazarnold27.countriesdetails.listeners.CountryListeners;
            ...
            public void onResponse(JSONArray response) {
                try {
                    for (int i = 0; i < 50; i++) {
                        ...
                        @SuppressLint("StaticFieldLeak")
                        class SaveCountry extends AsyncTask<Void, Void, Void> {
